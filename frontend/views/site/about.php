...
$começou = strtotime('21:00:00');
// just for loocalhost 1 hour more;
$current_time = time();
$time = $current_time - $começou;
$hours = date('h', $time);
$mins = date('i', $time);
$seconds = date('s', $time);
$status = 'start';
    ...
    <div class="row">
        <div class="col-md-6">
            <section class="panel">
                <div class="timer"></div>
                <!-- start watch -->
                <button class='btn btn-success btn-start'>Start</button>
                <button class='btn btn-warning btn-stop'>Pause</button>
                <button class='btn btn-danger btn-stop'>Finish</button>
